...
void InitMob_BCC_nl_Eshelby_Resist(Home_t *home)
{
        ...
        if ((param->MobEshelbyResist <= 0.0) ||
            isnan(param->MobEshelbyResist) ||
            isinf(param->MobEshelbyResist)) {
            Fatal("InitMob_BCC_nl_Eshelby_Resist: MobEshelbyResist "
                  "must be finite and greater than zero (value=%e)",
                  param->MobEshelbyResist);
        }
...
/**************************************************************************
 *
 *      Function:     Mobility_BCC_nl_Eshelby_Resist
 ...
 *
 *************************************************************************/
int Mobility_BCC_nl_Eshelby_Resist(Home_t *home, Node_t *node,
                                    MobArgs_t *mobArgs)
{
 ...
 */
        if (numNbrs > MAX_NBRS) {
            Fatal("Mobility_BCC_nl_Eshelby_Resist: Node segment count (%d) "
                  "exceeds\n"
